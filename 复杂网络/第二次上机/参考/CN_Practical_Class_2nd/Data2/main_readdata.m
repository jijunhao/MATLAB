%该程序用来读取数据
tic;
filename = './as20000102.txt/as20000102.txt';
[EdgeFromNode,EdgeToNode]=textread(filename,'%n%n','delimiter', ' ','headerlines', 4);
...
% dm_DC=max(r_index);%因为LB的指标是连续变化的，所以N2就是最大连通子图LB的节点个数
